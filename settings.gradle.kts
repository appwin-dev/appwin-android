...
dependencyResolutionManagement {
  ...
  repositories {
    google()
    mavenCentral()
    // TikTok Business SDK is not on Maven Central; JitPack builds it
    // from the official tiktok/tiktok-business-android-sdk repo.
...
include(":appwin-analytics")
include(":appwin-attribution")
include(":appwin-tiktok-events")
