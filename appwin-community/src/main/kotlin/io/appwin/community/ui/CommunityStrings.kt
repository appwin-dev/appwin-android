...
internal class CommunityStrings(private val context: Context) {
  ...
  fun reactionLabel(kind: CommunityReactionKind): String =
    when (kind) {
      CommunityReactionKind.LIKE ->
        t("appwin_community_reaction_like", R.string.appwin_community_reaction_like)
      CommunityReactionKind.LOVE ->
        t("appwin_community_reaction_love", R.string.appwin_community_reaction_love)
      CommunityReactionKind.LAUGH ->
        t("appwin_community_reaction_laugh", R.string.appwin_community_reaction_laugh)
      CommunityReactionKind.WOW ->
        t("appwin_community_reaction_wow", R.string.appwin_community_reaction_wow)
      CommunityReactionKind.SAD ->
        t("appwin_community_reaction_sad", R.string.appwin_community_reaction_sad)
      CommunityReactionKind.CLAP ->
        t("appwin_community_reaction_clap", R.string.appwin_community_reaction_clap)
    }
  ...
  val composerAnonymousHint: String
    get() = t(
      "appwin_community_composer_anonymous_hint",
      R.string.appwin_community_composer_anonymous_hint,
    )
  val composerLeaveAnonymous: String
    get() = t(
      "appwin_community_composer_leave_anonymous",
      R.string.appwin_community_composer_leave_anonymous,
    )
