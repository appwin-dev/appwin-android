...
val MODULE_DESCRIPTIONS =
  mapOf(
    ...
    "appwin-notifications" to
      ...
      "in-app messages.",
    "appwin-analytics" to
      "Appwin SDK for Android - analytics. Behavioral events with a " +
      "persisted offline queue, sessions and GDPR consent.",
    "appwin-attribution" to
      "Appwin SDK for Android - attribution. Acquisition signals: Play " +
      "Install Referrer, advertising identity and ad-network adapters.",
    "appwin-tiktok-events" to
      "Appwin SDK for Android - TikTok adapter. Optional ad-signals module " +
      "wrapping the TikTok App Events SDK behind the Appwin surface.",
  )
...
subprojects {
  ...
  plugins.withId("com.android.library") {
    ...
    extensions.configure<MavenPublishBaseExtension> {
      ...
      // automaticRelease: the publish workflow runs unattended in the
      // mirror's CI - a validated deployment left waiting for a portal
      // click is a release that silently never ships.
