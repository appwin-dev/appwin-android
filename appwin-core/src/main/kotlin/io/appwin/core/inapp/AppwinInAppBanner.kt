...
public object AppwinInAppBanner {
  ...
  /**
   * Whether [present] would draw right now. A foreground push asks before
   * choosing between the banner and a system notification: [present] drops
   * silently, and a dropped push would be lost.
   */
  @AppwinInternalApi
  public val canPresent: Boolean
    get() = currentActivity?.get() != null && !isSuppressed
