...
dependencies {
  ...
  // Analytics pipeline: app-wide foreground/background for session cuts and
  // flush-on-background (ProcessLifecycleOwner).
  implementation(libs.androidx.lifecycle.process)
  // Play Install Referrer (ADR-0038): Android's install-source signal.
  implementation(libs.installreferrer)
  // GAID for S2S activation match rate (ADR-0038); degrades to null
  // at runtime on GMS-less hosts.
