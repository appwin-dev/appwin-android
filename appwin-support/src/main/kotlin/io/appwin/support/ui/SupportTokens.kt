...
internal object SupportTokens {
  ...
  /**
   * iOS `AppwinTokens.shadowSmooth` - slate `#020617` at 5%.
   * Default Compose elevation shadows are much heavier and read as "Material".
   */
  val shadowSmooth: Color = Color(0x0D020617)
  ...
  /** Composer row: the field and the send button share it, as in Figma's 48dp actions. */
  val composerHeight = 48.dp
  val composerPadding = 14.dp
...
/**
 * Soft card elevation matching iOS (`shadowSmooth`, radius 2, y: 2).
 * Prefer this over bare [Modifier.shadow] so home / inbox cards stay light.
 */
internal fun Modifier.softCardShadow(shape: Shape): Modifier =
  shadow(
    elevation = 2.dp,
    shape = shape,
    clip = false,
    ambientColor = SupportTokens.shadowSmooth,
    spotColor = SupportTokens.shadowSmooth,
  )
